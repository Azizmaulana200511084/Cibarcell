			...
			<form method="post">
				<table style="position:relative; left:25%;">
					<tr style="display: none;">
						<td style="font-size:20px;">Email:</td><td><input type="email" name="email" value="<?php echo $email; ?>" style="width:400px;" ></td>
					</tr>
					<tr>
						<td style="font-size:20px;">Pesan Anda:</td><td><textarea name="message" style="width:400px; height:300px;" required></textarea></td>
					</tr>
					<tr>
						<td></td><td><button class="btn btn-info" name="send" style="width:100%;"><i class="icon icon-ok icon-white"></i>Kirim Pesan</button></a></td>
					</tr>
				</table> 
			</form> 
		</div>
