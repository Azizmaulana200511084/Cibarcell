...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%; z-index:auto;">
			<div class="alert alert-info" style="background-color:#333; color:aliceblue;"><center><h2>Pesan</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Cari Pesan..." id="filter"></label>
			<br />
