...
<svg xmlns="http://www.w3.org/20/svg" viewBox="0 0 1440 320" style="position:fixed; z-index:-1000;">
	...
	<br>
				...
				<div class="modal-body">
					...
					<center>
						<table>
							...
							<tr>
								<td><input type="text" name="product_color" placeholder="Colour" style="width:250px;" maxLength="20" required></td>
							</tr>
							<tr>
		...
		<?php
			if (isset($_POST['add']))
				...
				header ("location:admin_smartphone.php");
			}}
		}
	...
	<div id="rightcontent" style="position:absolute; top:10%; z-index: -1;">
			<div class="alert alert-info" style="background-color:#333; color:aliceblue;"><center><h2>Transaksi	</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Cari Transaksi..." id="filter"></label>
			<br />
			...
			<table class="table table-hover" style="background-color:#333; color:aliceblue;">
				...
				<tr>
					...
					echo '| <a class="btn btn-mini btn-info" href="confirm.php?id='.$id.'">Konfirmasi</a> ';
					echo '| <a class="btn btn-mini btn-danger" href="cancel.php?id='.$id.'">Batalkan</a></td>';
					}					
					?>
					<td>
