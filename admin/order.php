...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%; z-index:auto;">
			<div class="alert alert-info" style="background-color:#333; color:aliceblue;"><center><h2>Orders</h2></center></div>
			<br />
				<div style='width:975px; background-color:#333; color:aliceblue;' class="alert alert-info">
					  <table class="table table-hover">	
						<thead>	
							<th>Produk</th>
							<th>Monor Transaksi</th>
							<th>Jumblah</th>
						</thead>
						  <tbody>
							<?php 
