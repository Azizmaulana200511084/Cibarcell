...
<body>
	...
	<div id="leftnav" style="background-color: #333; color: white;">
		<ul>
			...
			<li><a href="admin_home.php" style="color: white;">Products</a>
				<ul>
					<li><a href="admin_feature.php "style="font-size:15px; margin-left:15px; color: white;">Features</a></li>
			...
			<li><a href="transaction.php" style="color: white;">Transactions</a></li>
			<li><a href="customer.php" style="color: white;">Customers</a></li>
			<li><a href="message.php" style="color: white;">Messages</a></li>
	...
	<label style="font-size:25px;">CibarCell</label>
