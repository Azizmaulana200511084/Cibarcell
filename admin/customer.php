...
<body>
	...
	<div id="rightcontent" style="position:absolute; top:10%; z-index: auto;">
			<div class="alert alert-info" style="background-color:#333; color:aliceblue;"><center><h2>Kustomer</h2></center></div>
			<br />
				<label  style="padding:5px; float:right;"><input type="text" name="filter" placeholder="Cari Kustomer..." id="filter"></label>
			<br />
		...
		<div class="alert alert-info" style="background-color:#333; color:aliceblue;">
			<table class="table table-hover" style="background-color:#333; color:aliceblue;">
				...
				?>
				<tr>
					<td><?php echo $fetch['firstname'];?>&nbsp;<?php ?>&nbsp;<?php 
