...
<div id="container">
	<div class="nav" style="padding-bottom: 5%;">
		...
		?>
				<div>
					<center>
						...
						<?php echo "<a href='cart.php?id=".$id."&action=add'><input type='submit' class='btn btn-inverse' name='add' value='Tambah Ke Keranjang'></a> &nbsp;  <a href='smartphone1.php'><button class='btn btn-inverse'>Batal</button></a> " ?>
					</center>
				</div>
		<?php }?>
			...
			<div class="modal-header">
				...
				<div class="modal-body">
					...
					<center>
						...
						<br />
						<input type="checkbox" required> I Agree the <a href="#terms" data-toggle="modal"> Terms and Condition</a>
					</center>
				</div>
			<div class="modal-footer">
				<center>
		...
		<div id="terms" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="width:400px;">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
				<h3 id="myModalLabel">CibarCell Terms and Condition</h3>
			</div>
				<div class="modal-body">
					<ul>
