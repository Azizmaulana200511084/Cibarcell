...
<div id="container">
	...
	<div class="nav" style="padding-bottom: 5%;">
		...
		<div class="nav1">
			<ul>
				<li><a href="smartphone1.php">SmartPhone</a></li>
				<li>|</li>
				<li><a href="aksesoris1.php">Aksesoris</a></li>
				<li>|</li>
				<li><a href="gatget1.php" class="active" style="color:#111;">Gatged Elektronik</a></li>
			</ul>
				<a href="cart.php"><button class="btn btn-inverse" style="right:1%; position:fixed; top:10%;"><i class="icon-shopping-cart icon-white"></i> Keranjang</button></a>
		</div>
